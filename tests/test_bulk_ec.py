...
def arrays_equal(a, b):
    # Check if nan positions match in both arrays
    nan_a = np.isnan(a)
    nan_b = np.isnan(b)
    ...
    # Check if non-nan values match in both arrays
...
def test_sample_C0c():
        ...
        expected_result = np.array([0.008388, 0.008388, 0.008815, 0.008867, 0.008924, 0.008988, np.nan, 0.008388, 0.009239, 0.009355, 0.009528, 0.009774])
        assert arrays_equal(BulkEC(sample_C0c), expected_result)
